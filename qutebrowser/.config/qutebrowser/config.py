...
c.bindings.commands = {
    "normal": {
        ...
        "ep": "spawn --userscript ~/.config/qutebrowser/qute-keepass -p '~/.keepass/passwords.kdbx' --password-fill-only",
        "eu": "spawn --userscript ~/.config/qutebrowser/qute-keepass -p '~/.keepass/passwords.kdbx' --username-fill-only",
        "]b": "tab-next",
        "[b": "tab-prev",
        "]B": "tab-move +",
        "[B": "tab-move -",
...
c.colors.statusbar.url.error.fg = black1
c.colors.statusbar.url.fg = black1
c.colors.statusbar.url.hover.fg = black1
c.colors.statusbar.url.success.http.fg = black1
c.colors.statusbar.url.success.https.fg = black1
c.colors.statusbar.url.warn.fg = black1
