...
class LocaleRegexDescriptor:
    ...
    def __get__(self, instance: RegexPattern | None, cls: type[RegexPattern] = ...) -> LocaleRegexDescriptor: ...
...
class URLResolver:
    ...
    def resolve_error_handler(self, view_type: int) -> tuple[Callable[..., Any], dict[str, Any]]: ...
