...
def normalize_together(option_together: Sequence[tuple[str, str]] | tuple[str, str]) -> tuple[tuple[str, str], ...]: ...
def make_immutable_fields_list(
    name: str,
    data: (Iterator[Any] | list[ArrayField[Any] | CIText] | list[Field[Any, Any] | FieldCacheMixin]),
) -> ImmutableList[Any]: ...
