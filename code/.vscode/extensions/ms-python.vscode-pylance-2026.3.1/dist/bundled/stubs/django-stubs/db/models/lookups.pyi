...
class Lookup(Generic[_T]):
    ...
    def get_db_prep_lookup(self, value: int | str, connection: DatabaseWrapper) -> tuple[str, list[SafeText]]: ...
    def process_lhs(
        self,
        compiler: SQLCompiler,
        connection: DatabaseWrapper,
    ...
    def process_rhs(self, compiler: SQLCompiler, connection: DatabaseWrapper) -> tuple[str, list[int | str]]: ...
