...
def iter_format_modules(lang: str, format_module_path: list[str] | str | None = ...) -> Iterator[Any]: ...
def get_format_modules(lang: str | None = ..., reverse: bool = ...) -> list[Any]: ...
def get_format(format_type: str, lang: str | None = ..., use_l10n: bool | None = ...) -> str: ...
...
def localize_input(value: datetime | Decimal | float | str | None, default: str | None = ...) -> str | None: ...
