...
class BaseDatabaseOperations:
    ...
    def distinct_sql(self, fields: list[str], params: list[Any] | None) -> tuple[list[str], list[Any]]: ...
    ...
    def for_update_sql(self, nowait: bool = ..., skip_locked: bool = ..., of: Any = ...) -> Any: ...
    ...
    def combine_duration_expression(self, connector: Any, sub_expressions: Any) -> Any: ...
    ...
    def window_frame_rows_start_end(self, start: int | None = ..., end: int | None = ...) -> Any: ...
    def window_frame_range_start_end(self, start: int | None = ..., end: int | None = ...) -> Any: ...
