...
class ForwardManyToOneDescriptor:
    ...
    def __get__(self, instance: Model | None, cls: type[Model] = ...) -> Model | ForwardManyToOneDescriptor | None: ...
...
class ReverseOneToOneDescriptor:
    ...
    def __get__(self, instance: Model | None, cls: type[Model] = ...) -> Model | ReverseOneToOneDescriptor: ...
    def __set__(self, instance: Model, value: Model | None) -> None: ...
    def __reduce__(self) -> tuple[Callable[..., Any], tuple[type[Model], str]]: ...
...
class ReverseManyToOneDescriptor:
    ...
    def __get__(self, instance: Model | None, cls: type[Model] = ...) -> ReverseManyToOneDescriptor: ...
...
def create_forward_many_to_many_manager(superclass: Any, rel: Any, reverse: Any) -> _ForwardManyToManyManager[Any]: ...
