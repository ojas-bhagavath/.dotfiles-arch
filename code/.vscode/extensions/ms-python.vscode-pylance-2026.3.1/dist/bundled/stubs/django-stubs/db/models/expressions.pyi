...
class Combinable:
    ...
    def __add__(self, other: timedelta | Combinable | _Numeric | str | None) -> Self: ...
    ...
    def __radd__(self, other: datetime | _Numeric | Combinable | None) -> Combinable: ...
...
class Func(SQLiteNumericMixin, Expression):
    ...
    extra: dict[Any, Any] = ...
    def __init__(self, *expressions: Any, output_field: _OutputField | None = ..., **extra: Any) -> None: ...
...
class Case(Expression):
    ...
    extra: Any = ...
    def __init__(
        self, *cases: Any, default: Any | None = ..., output_field: _OutputField | None = ..., **extra: Any
    ) -> None: ...

class ExpressionWrapper(Expression):
    def __init__(self, expression: Q | Combinable, output_field: _OutputField) -> None: ...

class Col(Expression):
    def __init__(self, alias: str, target: str, output_field: _OutputField | None = ...) -> None: ...

class SimpleCol(Expression):
    contains_column_references: bool = ...
    def __init__(self, target: Field[Any, Any], output_field: _OutputField | None = ...) -> None: ...
...
class WindowFrame(Expression):
    ...
    def window_frame_start_end(self, connection: Any, start: int | None, end: int | None) -> tuple[int, int]: ...
