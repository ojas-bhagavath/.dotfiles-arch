...
class DatabaseOperations(BaseDatabaseOperations):
    ...
    def datetime_extract_sql(self, lookup_type: Any, field_name: Any, tzname: Any) -> Any: ...
    def datetime_trunc_sql(self, lookup_type: Any, field_name: Any, tzname: Any) -> Any: ...
    ...
    def conditional_expression_supported_in_where_clause(self, expression: Any) -> Any: ...
