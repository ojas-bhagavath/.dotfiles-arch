...
class NestedObjects(Collector):
    ...
    def related_objects(self, related: ManyToOneRel, objs: Sequence[Model | None]) -> QuerySet[Any]: ...
...
def construct_change_message(form: BaseForm, formsets: None, add: bool) -> list[dict[str, dict[str, list[str]]]]: ...
