...
class ProgressBar:
    ...
    total_count: int = ...
    prev_done: int = ...
    def __init__(self, output: StringIO | OutputWrapper | None, total_count: int) -> None: ...
...
class Deserializer:
    options: dict[str, Any] = ...
    stream: Any = ...
    def __init__(self, stream_or_string: BufferedReader | TextIOWrapper | str, **options: Any) -> None: ...
...
def build_instance(Model: type[Model], data: dict[str, date | int | str | UUID | None], db: str) -> Model: ...
def deserialize_m2m_values(field: ManyToManyField[Any, Any], field_value: Any, using: str) -> list[Any]: ...
def deserialize_fk_value(field: ForeignKey[Any], field_value: Any, using: str) -> Any: ...
