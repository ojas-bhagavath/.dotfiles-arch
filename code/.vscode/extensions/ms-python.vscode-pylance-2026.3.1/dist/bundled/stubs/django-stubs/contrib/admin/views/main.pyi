...
class ChangeList:
    ...
    def get_filters(self, request: HttpRequest) -> tuple[list[ListFilter], bool, dict[str, bool | str], bool]: ...
    ...
    def get_ordering_field(self, field_name: Callable[..., Any] | str) -> CombinedExpression | str | None: ...
    def get_ordering(self, request: HttpRequest, queryset: QuerySet[Any]) -> list[OrderBy | Combinable | str]: ...
