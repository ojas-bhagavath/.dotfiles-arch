...
class AlterUniqueTogether(FieldRelatedOptionOperation):
    ...
    def __init__(self, name: str, unique_together: Collection[Sequence[str]] | None) -> None: ...

class AlterIndexTogether(FieldRelatedOptionOperation):
    option_name: str = ...
    index_together: Collection[Sequence[str]] = ...
    def __init__(self, name: str, index_together: Collection[Sequence[str]] | None) -> None: ...
