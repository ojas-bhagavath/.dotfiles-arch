...
def ChangeDisplaySettings(DevMode: _win32typing.PyDEVMODEW, Flags, /): ...
def ChangeDisplaySettingsEx(DeviceName: str | None = ..., DevMode: _win32typing.PyDEVMODEW | None = ..., Flags=...) -> int: ...
